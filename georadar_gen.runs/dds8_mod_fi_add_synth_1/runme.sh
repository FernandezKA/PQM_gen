...
HD_PWD='C:/dev/FPGA/PQM_gen/georadar_gen/georadar_gen.runs/dds8_mod_fi_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds8_mod_fi_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds8_mod_fi_add.tcl
