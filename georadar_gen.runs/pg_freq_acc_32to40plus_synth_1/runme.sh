...
HD_PWD='C:/dev/FPGA/PQM_gen/georadar_gen/georadar_gen.runs/pg_freq_acc_32to40plus_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pg_freq_acc_32to40plus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pg_freq_acc_32to40plus.tcl
