...
HD_PWD='C:/dev/FPGA/PQM_gen/georadar_gen/georadar_gen.runs/dds_lut_25x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_lut_25x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_lut_25x16.tcl
