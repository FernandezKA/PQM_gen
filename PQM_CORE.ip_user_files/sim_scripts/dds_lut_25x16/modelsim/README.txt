...
#
# Generated by export_simulation on Mon Apr 04 19:39:02 +0300 2022
#
################################################################################
...
'-reset_run' switch to the './dds_lut_25x16.sh' script.

./dds_lut_25x16.sh -reset_run
...
./dds_lut_25x16.sh -noclean_files

For more information on the script, please type './dds_lut_25x16.sh -help'.
