...
BEGIN
	...
	CARRIER_ACCUM : ENTITY work.pg_freq_acc_32to40plus
		PORT MAP(
			CLK => clk_seq,
			C => carrier_inc_reg(31) & carrier_inc_reg(31) & carrier_inc_reg(31) & carrier_inc_reg(31) & carrier_inc_reg(31) & carrier_inc_reg(31) & carrier_inc_reg(31) & carrier_inc_reg(31) & carrier_inc_reg & x"00",
			CONCAT => carrier_freq_init & x"0000",
			P => carrier_reg,
			CECONCAT5 => f_ce,
			CEC5 => f_inc_ce,
			CEP => p_ce,
	...
	ROTATOR_ACCUM : ENTITY work.pg_freq_acc_32to40plus
		PORT MAP(
			clk => clk_seq,
			c => rotator_inc_reg(31) & rotator_inc_reg(31) & rotator_inc_reg(31) & rotator_inc_reg(31) & rotator_inc_reg(31) & rotator_inc_reg(31) & rotator_inc_reg(31) & rotator_inc_reg(31) & rotator_inc_reg & x"00",
			CONCAT => rotator_freq_init & x"0000",
			P => rotator_reg,
			CECONCAT5 => f_ce,
			CEC5 => f_inc_ce,
			CEP => p_ce,
